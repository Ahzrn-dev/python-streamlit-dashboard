...
if st.toggle("On/Off") :
    st.write ("turn off that boy!!!!")

x=st.slider("selec a value",-50,100,0)
st.write(x)    

contatct_type=st.selectbox(
    "whats your favorite device",
    ("phone","macbook","ipad"),
)
st.write(f'your favorite device is {contatct_type}')

contatct_type=st.multiselect(
    "whats your favorite device",
    ("phone","macbook","ipad"),
)
st.write(f'your favorite device is {contatct_type}')